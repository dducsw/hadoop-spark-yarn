...
class BaseCuratedJob(BaseSparkJob):
    def __init__(self, feature_name: str, stage_table_name: Optional[str] = None,
        ...
        source_table = f"{stage_db}.stage_{stage_table}"
        target_table = f"{curated_db}.{feature_name}"
        super().__init__(pipeline_layer="curated", table_name=feature_name, source_table=source_table,
    ...
    def transform(self, df: DataFrame) -> DataFrame:
        ...
        # 2. Add curated lineage timestamp
