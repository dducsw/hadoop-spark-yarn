#!/usr/bin/env python3
"""Stage Job: Clean, deduplicate, and cast application_test into stage_application_test."""
import argparse
import os
import sys
...
class StageApplicationTestJob(BaseStageJob):
    def __init__(
        self,
...
def main():
    parser = argparse.ArgumentParser(description="Build stage_application_test")
